...
public class RoomDAO {
	...
	// property constants
	public static final String ROOM_NICK = "roomNick";
	...
	public List findByExample(Room instance) {
		...
		try {
			List results = getCurrentSession()
					.createCriteria("com.system.pojos.Room")
	...
	public List findByRoomNick(Object roomNick) {
		return findByProperty(ROOM_NICK, roomNick);
	}
