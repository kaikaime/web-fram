...
public class StudentDAO {
	...
	// property constants
	public static final String STUDENT_NICK = "studentNick";
	...
	public List findByExample(Student instance) {
		...
		try {
			List results = getCurrentSession()
					.createCriteria("com.system.pojos.Student")
	...
	public List findByStudentNick(Object studentNick) {
		return findByProperty(STUDENT_NICK, studentNick);
	}
	...
	public List findByStudentIdCard(Object studentIdCard) {
		return findByProperty(STUDENT_ID_CARD, studentIdCard);
	}
