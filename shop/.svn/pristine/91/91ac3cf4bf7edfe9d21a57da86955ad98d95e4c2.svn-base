...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>新增用户</h2>
		<div class="manage">
			<form  name=form1 action="${pageContext.request.contextPath }/userma.do?method=addUser" method="post" enctype="multipart/form-data">
				<table class="form">
					<tr>
					...
					<tr>
						...
						<td><input type="text" class="text" name="userEmail" value="" /></td>
					</tr>
					<tr>
