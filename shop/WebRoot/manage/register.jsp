...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			...
			<form id="regForm" method="post" action="${pageContext.request.contextPath}/login.do?method=register" onsubmit="return checkForm(this);">
				<table>
					<tr>
					...
					<tr>
						...
						<td><input class="text verycode" type="text" name="veryCode" onfocus="FocusItem(this)" onblur="CheckItem(this);" placeholder="${msg}"/><img id="veryCode" class="very_class" src="${pageContext.request.contextPath}/verycode.do?veryCode=veryCode" /><span></span></td>
					</tr>
					<tr>
						<td></td>
